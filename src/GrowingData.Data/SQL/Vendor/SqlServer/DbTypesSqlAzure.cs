...
namespace GrowingData.Data {
	...
	/// <summary>
	/// Defines the <see cref="SqlServerType" />
	/// </summary>
	public class SqlServerType {
		/// <summary>
		/// Defines the DatabaseTypeName
		/// </summary>
		...
		/// <summary>
		/// Defines the MungType
		/// </summary>
		public SimpleDbType MungType;

		/// <summary>
		/// Initializes a new instance of the <see cref="SqlServerType"/> class.
		/// </summary>
		/// <param name="mt">The <see cref="SimpleDbType"/></param>
		/// <param name="infoSchemaName">The <see cref="string"/></param>
		/// <param name="columnDefinition">The <see cref="string"/></param>
		public SqlServerType(SimpleDbType mt, string infoSchemaName, string columnDefinition) {
			MungType = mt;
			InfoSchemaName = infoSchemaName;
			DatabaseTypeName = columnDefinition;
		}
	}

	/// <summary>
	/// Defines the <see cref="DbTypesSqlAzure" />
	/// </summary>
	public class DbTypesSqlAzure : DbTypeConverter {
		/// <summary>
		...
		public static List<SqlServerType> Types = new List<SqlServerType>() {
			...
			new SqlServerType(SimpleDbType.Get(typeof(double)), "numeric", "float"),
